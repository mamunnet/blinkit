      ...
      <ScrollView
        ...
        <View style={styles.flexRow}>
          ...
          <View style={{ width: '82%' }}>
            ...
            <CustomText variant='h9' fontFamily={Fonts.Medium}>Hit Like and subscribe button! If you are enjoying comment your excitement</CustomText>
          </View>
