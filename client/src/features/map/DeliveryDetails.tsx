        ...
        <View style={styles.container}>
            ...
            <View style={styles.flexRow2}>
                ...
                <View style={{ width: '80%' }}>
                    ...
                    <CustomText variant='h8' numberOfLines={2} fontFamily={Fonts.Regular}>{details?.address || '-----'}</CustomText>
                </View>
            </View>
            ...
            <View style={styles.flexRow2}>
                ...
                <View style={{ width: '80%' }}>
                    <CustomText variant='h8' fontFamily={Fonts.Medium}>{details?.name || '--'} {details?.phone || 'XXXXXXXX'}</CustomText>
