    ...
    const WithLiveOrder: FC<P> = (props) => {
            ...
            if (currentOrder) {
                const watchId = Geolocation.watchPosition(
                    async (position) => {
                        ...
                        console.log("LIVE TRACKING 🔴", " LAT: ", new Date().toLocaleTimeString(), latitude.toFixed(3), "LONG: ", longitude.toFixed(3));
        ...
        return (
            <View style={styles.container}>
                ...
                {currentOrder && (
                    <View style={[hocStyles.cartContainer, { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20 }]}>
